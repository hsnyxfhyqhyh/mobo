...
public class UserHandler extends SQLiteOpenHelper {
    ...
    // for our logs
    public static final String TAG = "UserHandler.java";
...
//        onCreate(db);
     ...
     */
    public boolean create(UserDTO setDTO) {
    ...
    public boolean checkIfExists(String userName_){
        
        boolean recordExists = false;
                
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery("SELECT " + fieldName + " FROM " + tableName + " WHERE " + fieldName + " = '" + userName_ + "'", null);
    ...
    public ArrayList<UserDTO> getUsers() {
    	...
    	ArrayList <UserDTO> sets = new ArrayList<UserDTO> ();
