...
import com.ying.exercise.fragment.MachinePerformanceListFragment;
...
public class MachinePerformanceListActivity extends FragmentActivity {
	...
	private void displayList() {
		...
		if ( container != null) {
			...
			if (preferences.getUserName().equals("")) {
				...
				MachinePerformanceListFragment firstFragment = new MachinePerformanceListFragment();
