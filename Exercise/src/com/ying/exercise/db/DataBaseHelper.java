...
public class DataBaseHelper extends SQLiteOpenHelper {
	...
	private static final String PACKAGE_NAME = "com.ying.exercise";
	
	private String DB_PATH = String.format("/data/data/%s/databases/", PACKAGE_NAME);
	private String BACK_FOLDER_NAME = "Exercise";
	
	// private String DB_PATH =
	// mycontext.getApplicationContext().getPackageName()+"/databases/";
	private static final String DB_NAME_TEMPLATE = "Exercise%s.db";
...
//		InputStream myinput = mycontext.getAssets().open(DB_NAME);
		...
		String subBackupDBPath = String.format("/Download/%s/%s" , BACK_FOLDER_NAME, DB_NAME);
